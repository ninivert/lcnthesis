...
![Every neuron in a rate neural network has a position in the $p$-dimensional embedding space](figures/fig-rnn.svg){width=500px}
...
![Good mappings from $\Rp$ to $[0,1]$ should maintain some sense of "locality"](figures/fig-locality.svg){width=600px}
