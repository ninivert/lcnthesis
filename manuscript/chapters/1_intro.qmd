...
![(TODO add phi, add z instead of xi, arrow only in one direction) Every neuron in a rate neural network has a position in the $p$-dimensional embedding space](figures/neural_field_discrete.png)
